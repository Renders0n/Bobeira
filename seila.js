...
const gifElement = document.getElementById("morales-gif");
...
const gifs = ["img/morales-gwen.gif", "img/morales-lol.gif", "img/morales-gwen.gif", "img/morales-crying.gif"];
// array of messages
const buttonMessages = ["Are you sure??", "Dude please", "BigHead PLEASE", "You can't do that to nigga!"];
